...
Now that you’ve seen the structure of the **{module}** folder, you can reuse my codes, by forking [**{module}**](https://github.com/kisha126/modules-in-r/module), found at the source code of this book, into any specified directory. 
...
::: callout-note
Do not forget to put `./` prefix to load specific modules in your project workspace. The lack of `./` prefix is only valid for R packages. 
:::
